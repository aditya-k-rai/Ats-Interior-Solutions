...
export const completeSolutionsData: CompleteSolutionItem[] = [
  {
    ...
    subtitle: "Smart Renovation & Space Upgrades",
  ...
  },
  {
    ...
    subtitle: "Realistic Renders & Concept Planning",
    description: "Bringing ideas to life with realistic 3D visuals and detailed concept designs. Review exact lighting, material textures, and spatial flows before on-site construction begins.",
    icon: Layout,
    keywords: ["Photo-realistic 3D Renders", "CAD Architectural Floor Plans", "Material & Lighting Moodboards"],
    href: "/services",
  ...
  },
  {
    ...
    subtitle: "Structural Planning & Sustainability",
    description: "Innovative designs combining functionality, aesthetics, and sustainability. Led by qualified architects for structural alterations, villa planning, and facade designs.",
    icon: PenTool,
    keywords: ["Villa & Penthouse Architecture", "Structural Elevation & Facade", "Green & Sustainable Materials"],
  ...
  },
  {
    ...
    description: "Hassle-free project completion with ready-to-use spaces on time and within budget. Full single-window accountability from civil work to final furniture placement.",
    icon: Building2,
    keywords: ["Single-Window Execution", "Milestone Delivery Guarantee", "Site Engineer Supervision"],
    href: "/process",
